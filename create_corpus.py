...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--data_dir", default="./data", type=str, help="path to training data"
    )
    parser.add_argument(
        "--save_dir", default="./generated_data", type=str, help="path to training data"
    )
    ...
    data = json.load(open(corpus_path, encoding="utf8"))

    save_dict = {}
    co_f = open(
        os.path.join(args.save_dir, "cocondenser_data.json"), "w", encoding="utf-8"
    )
    count = 0
